...
<div class="w3-container" style="padding-top: 2%;padding-left: 5%;">
	...
	<div class="w3-row-padding w3-center">
		...
		<div class="w3-col w3-container w3-hover-opacity" style="width:25%; cursor:pointer;">
			<a href="prestamo.jsp"><img src="../imagenes/flag.png" height="230" width="230" class="w3-circle" alt="Norway"><h2>Generar Prestamo</h2></a>
		</div>
		<div class="w3-col w3-container w3-hover-opacity" style="width:25%; cursor:pointer;">
			<a href="registros.jsp"><img src="../imagenes/eye.png" height="230" width="230" class="w3-circle" alt="Norway"><h2>Prestamos / multas</h2></a>
		</div>
		<div class="w3-col w3-container w3-hover-opacity" style="width:25%; cursor:pointer;">
			<a href="moderador.jsp"><img src="../imagenes/star.png" height="230" width="230" class="w3-circle" alt="Norway"><h2>Moderadores</h2></a>
		</div>
<!-- 		<div class="w3-col w3-container w3-hover-opacity" style="width:25%; cursor:pointer;"> -->
<!-- 			<a href="registros.jsp"><img src="../imagenes/eye.png" height="230" width="230" class="w3-circle" alt="Norway"><h2>Prestamos / multas</h2></a> -->
<!-- 		</div> -->
